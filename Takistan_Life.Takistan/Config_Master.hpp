...
class Licenses {
    ...
    LICENSEMACRO(patrol,"STR_License_Patrol","patrol",15000,false,"cop")
    LICENSEMACRO(response,"STR_License_Response","response",15000,false,"cop")
    LICENSEMACRO(sobr,"STR_License_Sobr","sobr",15000,false,"cop")
