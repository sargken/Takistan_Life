...
_resourceZones = ["apple_1","apple_2","peaches_1","peaches_2","heroin_1","cocaine_1","weed_1"];
_zone = "";
...
switch(true) do {
	case (_zone in ["apple_1","apple_2"]): {_gather = ["apple",3];};
	case (_zone in ["peaches_1","peaches_2"]): {_gather = ["peach",3];};
