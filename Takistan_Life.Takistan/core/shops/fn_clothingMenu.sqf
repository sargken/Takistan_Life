...
if((SEL(_this,3) in ["opf"] && playerSide != east)) exitWith {hint localize "STR_Shop_NotaOpfor"; closeDialog 0;};
if((SEL(_this,3) in ["ins"] && playerSide != independent)) exitWith {hint localize "STR_Shop_NotaOpfor"; closeDialog 0;};
